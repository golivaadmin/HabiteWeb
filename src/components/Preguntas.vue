...
<q-collapsible v-for="item in Preguntas"
:key="item.pregunta" class="container panel-group box-preguntas" :label="item.pregunta">
  <div v-html="item.respuesta">
...
<script src="./controllers/PreguntasController.js"></script>
